<?php
class Leza_Celebrities_Block_Adminhtml_List_Grid extends Mage_Adminhtml_Block_Widget_Grid{
    ...
    public function _prepareCollection() {
        ...
        $collection->clear()
        ->getSelect()->reset(Zend_Db_Select::ORDER)->joinLeft(
                ['celebrity_data' => 'celebrity_data'],
                'main_table.celebrity_id = celebrity_data.celebrity_id'
            )
            ->where("celebrity_data.store_id=1")
            ->order('main_table.celebrity_id desc');
