<?php
class Leza_Celebrities_Block_CelebritiesList extends Mage_Core_Block_Template
{
    ...
    public function getCelebritiesCollection() {
            ...
            $celebrityCollection->getSelect()->joinLeft(
                  ...
                  )->where('main_table.celebrity_status=1 AND cb.store_id='.$store_id.' AND main_table.celebrity_type != "T" ')->order('cb.celebrity_name', 'Asc');
